...
export default function MenuCard({
  ...
  item: Item;
  stock: number;      // current stock for this SKU
  cartQty: number;    // qty already in cart
  onAdd: (selected?: any) => void; // add 1 to cart
      ...
      <div className="h-40 w-full overflow-hidden bg-slate-100 grid place-items-center">
        {renderImage ? (
          ...
          <img
            ...
            onError={(e) => {
              (e.currentTarget as HTMLImageElement).src = "/products/cheetos.jpg"; // simple fallback
            }}
          />
        )}
      </div>
